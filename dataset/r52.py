...
class R52(pl.LightningDataModule):
    """
    """
    def __init__(self,data_path, config, pre_cache=True):
        super(R52,self).__init__()
    ...
    def init_attr_from_config(self):
        ...
        self.vocab_name = data_config.get('vocab','results/vocabs/r52_vocab.pt')
    ...
    def init_datasets(self):
        for split in ['train', 'test']:
            ...
            self.datasets[split] = R52Dataset(file_path=self.data_path,tokenizer=None,
    ...
    def init_collect_fn(self):
        if self.tokenizer_type == 'bert':
            self.train_val_test_collect_fn = R52Dataset.collate_fn_bert
        elif self.tokenizer_type == 'non_bert':
            self.train_val_test_collect_fn = R52Dataset.collate_fn_non_bert
        else:
...
class ExperimentR52(pl.LightningModule):
    # to complete
    '''
    ...
    def __init__(self, config):
        super(ExperimentR52, self).__init__()
