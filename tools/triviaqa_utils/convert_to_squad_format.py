...
def convert_to_squad_format(qa_json_file, squad_file):
    ...
    for qad in tqdm(qad_triples):
        ...
        'qas':[
            ...
            'answers': [{'text': 'hingis', 'answer_start': 188}]
            # answers: the answers occured in the document to the question
            # aliases: all the answers to the question
            'aliases': [
                        "hingis",
                        "swiss miss",
                        "martina hingis",
